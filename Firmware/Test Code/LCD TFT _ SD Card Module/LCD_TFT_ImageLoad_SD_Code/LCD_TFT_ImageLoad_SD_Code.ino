// TFT LCD Display with ILI9341 IC - Basic interfacing through SPI and loading images from built-in SD card interface
...
//Arduino Uno SPI HW - MOSI (11), MISO (12) & SCK (13)
